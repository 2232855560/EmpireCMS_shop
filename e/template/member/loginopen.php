...
<div class="app-content-body ">
  <table class="table table-bordered table-hover table-striped table_striped table_hover tableborder" width="100%" border="0" align="center" cellpadding="3" cellspacing="1" >
