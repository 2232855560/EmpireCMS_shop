...
?>
      <table class="table table-bordered table-hover table-striped table_striped table_hover" height="100%">
        ...
        <br>
        <table class="am-table am-table-bordered am-table-radius am-table-striped am-table-hover" height="100%">
          <form name=favaform method=post class="am-form" action="../doaction.php" onsubmit="return confirm('确认要操作?');">
			...
			?>
            <tr style="width:auto; height:50px; background-color:#fff; margin-bottom: 20px;"> 
