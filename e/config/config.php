...
$ecms_config['db']['dbpassword']='feihusky1234';	//数据库密码



$ecms_config['db']['dbname']='52pojie';	//数据库名
...
$ecms_config['esafe']['ecookiernd']='glM8kYy7v5WezxHafONQEkadFO54o7';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='tnngb';		//前台cookie变量前缀

$ecms_config['cks']['ckadminvarpre']='hzyyl';		//后台cookie变量前缀

$ecms_config['cks']['ckrnd']='5mSebtSfQIDVGNR8fLf0XmgRPgKrZP';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)

$ecms_config['cks']['ckrndtwo']='7j9Zh1FxVfkUaEe8Qm1uhF5QztqD01';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
...
//------------e_public
$public_r=array('sitename'=>'仅为吾爱破解免费提供',
'newsurl'=>'/',
...
'keytog'=>2,
'keytime'=>30,
'keyrnd'=>'v1EsOASajoxOTMUfudbqWGMcwuDCwO',
...
'fbkey_ok'=>0,
'newaddinfotime'=>0,
'classnavs'=>'<a href=\"/product/\">产品中心</a>',
'adminstyle'=>',1,2,',
'docnewsnum'=>300,
'openschall'=>0,
'schallfield'=>1,
...
'datatbs'=>',1,',
'deftb'=>'1',
'enter'=>',title,special.field,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,pic1,pic2,pic3,other,size,cc_color,cc_size,titlepic,productpic,newstext,',
'qenter'=>',',
'listtempf'=>',title,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,pic1,pic2,pic3,other,size,diggtop,cc_color,cc_size,titlepic,productpic,newstext,psalenum,',
'tempf'=>',title,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,pic1,pic2,pic3,other,size,diggtop,cc_color,cc_size,titlepic,productpic,newstext,psalenum,',
'mustqenterf'=>',title,newstext,',
'listandf'=>',price,cc_color,cc_size,',
'setandf'=>0,
'searchvar'=>',title,productno,materials,intro,price,newstext,',
'cj'=>',title,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,pic1,pic2,pic3,other,size,cc_color,cc_size,titlepic,productpic,newstext,',
'canaddf'=>',title,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,pic1,pic2,pic3,other,size,cc_color,cc_size,titlepic,productpic,newstext,',
'caneditf'=>',title,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,pic1,pic2,pic3,other,size,cc_color,cc_size,titlepic,productpic,newstext,',
'tbmainf'=>',title,titlepic,newstime,productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,productpic,newstext,psalenum,pic1,pic2,pic3,other,size,diggtop,cc_color,cc_size,',
'tbdataf'=>',',
'tobrf'=>',intro,newstext,',
'dohtmlf'=>',productno,materials,intro,dimensions,weight,tprice,price,buyfen,pmaxnum,productpic,newstext,psalenum,pic1,pic2,pic3,other,size,diggtop,cc_color,cc_size,',
'checkboxf'=>',',
'savetxtf'=>'',
'editorf'=>',newstext,',
'ubbeditorf'=>',',
...
'smalltextf'=>',',
'filef'=>',',
'imgf'=>',titlepic,productpic,pic1,pic2,pic3,',
'flashf'=>',',
'linkfields'=>'|',
'morevaluef'=>'|',
'onlyf'=>',',
